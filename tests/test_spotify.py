...
class SpotifyTests(unittest.TestCase):
 ...
 def test_playback_204_is_success(self):
  with mock.patch('modules.spotify.controller.requests.request',return_value=Response(204,{})): self.assertTrue(self.c.command('play')['ok'])
